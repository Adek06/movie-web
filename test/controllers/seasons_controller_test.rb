...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { belongs_to: @season.belongs_to, dir_path: @season.dir_path, title: @season.title } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { belongs_to: @season.belongs_to, dir_path: @season.dir_path, title: @season.title } }
