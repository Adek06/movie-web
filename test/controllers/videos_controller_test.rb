...
class VideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video" do
    assert_difference('Video.count') do
      post videos_url, params: { video: { file_path: @video.file_path, title: @video.title } }
    end
  ...
  test "should update video" do
    patch video_url(@video), params: { video: { file_path: @video.file_path, title: @video.title } }
